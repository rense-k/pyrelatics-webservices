...
from pyrelatics2 import ClientCredential, InvalidOperationError, InvalidWorkspaceError, RelaticsWebservices
...
#     print("Caught exception: Invalid workspace")
# except InvalidOperationError:
#     print("Caught exception: Invalid operation_name")
